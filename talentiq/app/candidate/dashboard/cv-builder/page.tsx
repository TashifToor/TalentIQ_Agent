  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--dash-bg)' }}>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '32px 16px 16px' }}>
        <Link href="/candidate/dashboard" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: 12, color: 'var(--dash-text-muted)', textDecoration: 'none', marginBottom: 12, fontFamily: 'Inter, sans-serif' }}>
          ← Back to Dashboard
        </Link>
      </div>
      <CVBuilderWizard onCvStateChange={setWizardState} externalCvUpdate={externalCvUpdate} light={theme === 'light'} />
