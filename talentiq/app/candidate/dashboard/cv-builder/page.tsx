  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a08' }}>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '32px 16px 16px' }}>
        <Link href="/candidate/dashboard" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: 12, color: 'rgba(255,255,255,.4)', textDecoration: 'none', marginBottom: 12, fontFamily: 'Inter, sans-serif' }}>
          ← Back to Dashboard
        </Link>
      </div>
