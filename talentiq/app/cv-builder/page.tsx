...
export default function PublicCVBuilderPage() {
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a08' }}>
      ...
      <header style={{ maxWidth: 900, margin: '0 auto', padding: '40px 16px 8px', textAlign: 'center', fontFamily: 'Inter, sans-serif' }}>
        <Link href="/" style={{ fontSize: 13, fontWeight: 700, color: '#d4af6d', textDecoration: 'none', letterSpacing: 1 }}>TALENTIQ</Link>
        <h1 style={{ fontFamily: "Inter, sans-serif", fontSize: 34, fontWeight: 600, color: '#f5f2eb', margin: '16px 0 10px' }}>
          Free AI CV Builder
        </h1>
      ...
      <footer style={{ textAlign: 'center', padding: '20px 16px 40px', fontSize: 12, color: 'rgba(245,242,235,.25)', fontFamily: 'Inter, sans-serif' }}>
